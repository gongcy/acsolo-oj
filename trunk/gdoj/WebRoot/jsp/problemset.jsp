  ...
  <body>  
      ...
      <div id="content" class="content-with-sidebar"> 	 <!-- class="content-with-sidebar" -->
	    ...
	    <div style="margin:0 12px;font-size:15px;">	
			...
			<div class="right">
					<s:if test="page>1">
						<a href="problemset/page/<s:property value="page-1"/><s:if test="order!=null">?ORDER=<s:property value="order"/></s:if>" style="color:#000;text-decoration: none;">  &larr; </a>
					</s:if>	
					<s:iterator value="pageList" status="st_page">				
						<s:if test="pageList[#st_page.index]==0">...</s:if>
						<s:else><a href="problemset/page/<s:property/><s:if test="order!=null">?ORDER=<s:property value="order"/></s:if>" style="color:#000;text-decoration: none;">
							<s:if test="page==pageList[#st_page.index]"><b><s:property/></b></s:if>
							<s:else><s:property/></s:else>
						</a></s:else>
					</s:iterator>	
					<s:if test="page < pageCount">		
						<a href="problemset/page/<s:property value="page+1"/><s:if test="order!=null">?ORDER=<s:property value="order"/></s:if>" style="color:#000;text-decoration: none;">  &rarr; </a>		
					</s:if>						
		   </div>
		</div>  	    	  
	</div>   
