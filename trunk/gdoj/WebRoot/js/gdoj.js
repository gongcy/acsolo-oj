...
if(IE6){
	...
	//alert("Sorry! This page doesn't support Internet Explorer 6.You can use chrome , firefox or IE7!");
...
function OnlineJudge(){
	...
	this.ping = function(pingUrl) {	
		//alert("ping");
		OnlineJudge.setCookie("lastOnlineTimeUpdaterInvocation", new Date().getTime());
        $.post(pingUrl, {}, function(result) {
        	for(var i in result.usersList){	
        		alert(result.usersList[i]);
        	}
